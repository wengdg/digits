...
alter table contact add constraint fk_contact_telType_1 foreign key (tel_type_id) references telephone_type (id) on delete restrict on update restrict;
create index ix_contact_telType_1 on contact (tel_type_id);
